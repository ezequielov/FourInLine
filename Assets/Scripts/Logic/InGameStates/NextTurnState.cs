...
public class NextTurnState : InGameState{
    ...
    public NextTurnState(Board board, BoardView view, int playersAmount, Dictionary<int, statesEnum> playersDictionary, Action<statesEnum> nextStateAction, Action<int> onNewCurrentPlayer, statesEnum myState) : base(board, view, nextStateAction, myState) {
